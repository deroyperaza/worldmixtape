...
function buildCountryList(){
  ...
  clist.innerHTML =
    '<div class="clist__head"><div class="brand__tape"><h1 class="brand__title"><img class="brand__logo" src="WMT-logo.svg?v=2" alt="World Mixtape"></h1></div><p class="brand__sub">a century of local music,<br>decade by decade</p></div>' +
